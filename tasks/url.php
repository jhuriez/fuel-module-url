...
class Url
{
    ...
    public function __construct()
    {
        ...
        $this->assetJsPath = $this->publicPath.DS.$this->assetFolder.DS.$this->activeTheme.DS.'js'.DS.'modules'.DS.$this->moduleName;
        $this->assetCssPath = $this->publicPath.DS.$this->assetFolder.DS.$this->activeTheme.DS.'css'.DS.'modules'.DS.$this->moduleName;
    }
	...
	public function install($publicPath = null, $theme = null)
	{
        ...
        if (is_dir($this->publicPath)) {
            ...
            die($this->moduleName . ' assets install : OK');
        } else {
    ...
    public function uninstall($publicPath = null, $theme = null)
    {
        ...
        if (is_dir($this->publicPath)) {
            ...
            die($this->moduleName . ' assets uninstall : OK');
        }
        else
        {
            die('Unknow public path : ' . $this->publicPath);
